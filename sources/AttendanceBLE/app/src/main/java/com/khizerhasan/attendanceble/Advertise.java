...
public class Advertise extends Service {
    private static final String TAG = Advertise.class.getSimpleName();
        ...
        if (mBluetoothLeAdvertiser == null) {
            ...
            if (mBluetoothManager != null) {
                ...
                if (mBluetoothAdapter != null) {
                    ...
                    Toast.makeText(this, getString(R.string.bt_obj_null), Toast.LENGTH_LONG).show();
                }
            } else {
                Toast.makeText(this, getString(R.string.bt_obj_null), Toast.LENGTH_LONG).show();
            }
    ...
    private AdvertiseData buildAdvertiseData() {
        ...
        dataBuilder.addManufacturerData(1,id.getBytes(Charset.forName("UTF-8")));
